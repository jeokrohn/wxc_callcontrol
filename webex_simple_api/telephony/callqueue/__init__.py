...
__all__ = ['CallQueueAPI', 'CallQueue', 'CallQueueDetail',
           'RingPattern', 'AlternateNumber', 'AlternateNumberSettings', 'CallBounce', 'DistinctiveRing', 'Policy',
...
class CallQueueAPI:
    ...
    async def create(self, location_id: str, queue: CallQueueDetail, org_id: str = None) -> str:
        """
        Create a Call Queue
        :param location_id:
        :param queue:
    ...
    async def details(self, location_id: str, queue_id: str, org_id: str = None) -> CallQueueDetail:
        """
    ...
    async def update_callqueue(self, location_id: str, queue_id: str, queue: CallQueueDetail, org_id: str = None):
        """
